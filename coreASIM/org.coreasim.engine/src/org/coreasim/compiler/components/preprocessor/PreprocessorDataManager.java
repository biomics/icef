...
public class PreprocessorDataManager {
	...
	private class Storage{
		...
		private List<InheritRule> getInheritRules(int pos, String...value){
			...
			List<InheritRule> result = new ArrayList<org.coreasim.compiler.components.preprocessor.InheritRule>();
		...
		private List<SynthesizeRule> getSynthesizeRules(int pos, String...value){
			...
			List<SynthesizeRule> result = new ArrayList<org.coreasim.compiler.components.preprocessor.SynthesizeRule>();
	...
	public PreprocessorDataManager(List<CompilerPlugin> plugins){
		List<SynthesizeRule> synth = new ArrayList<org.coreasim.compiler.components.preprocessor.SynthesizeRule>();
		List<InheritRule> inh = new ArrayList<org.coreasim.compiler.components.preprocessor.InheritRule>();
