package org.coreasim.compiler.components.mainprogram.statemachine;
...
import org.coreasim.compiler.components.classlibrary.EnumFile;
import org.coreasim.compiler.components.classlibrary.LibraryEntryType;
import org.coreasim.compiler.components.mainprogram.statemachine.EngineState;
import org.coreasim.compiler.components.mainprogram.statemachine.EngineTransition;
import org.coreasim.compiler.exception.ElementAlreadyExistsException;
import org.coreasim.compiler.exception.EntryAlreadyExistsException;
import org.coreasim.compiler.exception.InvalidCodeException;
import org.coreasim.compiler.exception.InvalidStateMachineException;
...
public class StateMachine {
	...
	public StateMachine(CompilerEngine engine){
		this.engine = engine;
		states = new ArrayList<org.coreasim.compiler.components.mainprogram.statemachine.EngineState>();
		transitions = new HashMap<String, HashMap<String, ArrayList<org.coreasim.compiler.components.mainprogram.statemachine.EngineTransition>>>();
		onEnter = new HashMap<String, ArrayList<org.coreasim.compiler.components.mainprogram.statemachine.EngineTransition>>();
		onLeave = new HashMap<String, ArrayList<org.coreasim.compiler.components.mainprogram.statemachine.EngineTransition>>();
		general = new ArrayList<org.coreasim.compiler.components.mainprogram.statemachine.EngineTransition>();
	}
	...
	public void addTransition(EngineTransition et){
		if(et.getStart() == null){
			if(et.getEnd() == null){
				...
				if(tmp == null){
					tmp = new ArrayList<org.coreasim.compiler.components.mainprogram.statemachine.EngineTransition>();
