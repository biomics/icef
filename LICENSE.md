...
The ICEF project is an open source project and implements a prototype of the theories
and technologies developed by the European FP7 research project BIOMICS (Grant no. 318202).

The source code of this project is licensed under the Academic Free License version 3.0.
This includes:

* CoreASIM Engine (also read JParsec-license.txt) - an extension of the original CoreASM modelling framework
* Standard plugins for the CoreASIM engine (including original CoreASM plugins)
* CoreASIM Eclipse Plugin - an extension of the original CoreASM Eclipse Plugin
* CoreASIM wrapper providing a REST interface for the CoreASIM engine
* CASIMA - The CoreASIM manager based on node.js
