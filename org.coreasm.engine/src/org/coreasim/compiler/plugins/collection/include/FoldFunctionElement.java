...
package org.coreasim.compiler.plugins.collection.include;
...
import org.coreasim.engine.plugins.collection.CollectionFunctionElement;
...
public class FoldFunctionElement extends CollectionFunctionElement {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6299325185194248782L;
	 ...
	 */
	public FoldFunctionElement(ControlAPI capi) {
		super(capi);
		this.isFoldR = false;
	}
