/*	
 * GetMessageReceiverFunctionElement.java 	1.0 	
 * 
 * 
 ...
 * 
 */
public class GetMessageReceiverFunctionElement extends FunctionElement {

	/**
	 * 
	 */
	public GetMessageReceiverFunctionElement() {
	...
	public Element getValue(List<? extends Element> args) {
		...
		else if (args.size() == 1) //has to be a message element 
		{
			...
			if (arg0 instanceof MessageElement)
			{
				...
				return new StringElement(theMessage.getToAgent());
			}else
			{
				return Element.UNDEF;
			}
