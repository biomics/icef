package org.coreasim.compiler.plugins.kernel;
...
import org.coreasim.compiler.components.classlibrary.JarInclude;
...
import org.coreasim.compiler.components.preprocessor.InheritRule;
import org.coreasim.compiler.components.preprocessor.SynthesizeRule;
...
import org.coreasim.compiler.interfaces.CompilerOperatorPlugin;
import org.coreasim.compiler.interfaces.CompilerPlugin;
import org.coreasim.compiler.interfaces.CompilerPreprocessorPlugin;
import org.coreasim.compiler.interfaces.CompilerVocabularyExtender;
import org.coreasim.compiler.plugins.kernel.code.bcode.KernelCoreHandler;
import org.coreasim.compiler.plugins.kernel.code.bcode.KernelInitHandler;
import org.coreasim.compiler.plugins.kernel.code.bcode.KernelRuleDeclarationHandler;
import org.coreasim.compiler.plugins.kernel.code.lcode.KernelFunctionRulePolicyTermHandler;
import org.coreasim.compiler.plugins.kernel.code.lcode.KernelIDCodeHandler;
import org.coreasim.compiler.plugins.kernel.code.lrcode.KernelLRFunctionRulePolicyTermHandler;
import org.coreasim.compiler.plugins.kernel.code.rcode.KernelBooleanTermHandler;
import org.coreasim.compiler.plugins.kernel.code.rcode.KernelExpressionLiftHandler;
import org.coreasim.compiler.plugins.kernel.code.rcode.KernelFunctionRuleExpressionHandler;
import org.coreasim.compiler.plugins.kernel.code.rcode.KernelRuleOrFuncHandler;
import org.coreasim.compiler.plugins.kernel.code.rcode.KernelSelfHandler;
import org.coreasim.compiler.plugins.kernel.code.rcode.KernelUndefHandler;
import org.coreasim.compiler.plugins.kernel.code.ucode.KernelImportRule;
import org.coreasim.compiler.plugins.kernel.code.ucode.KernelMacroCallRule;
import org.coreasim.compiler.plugins.kernel.code.ucode.KernelSkipRule;
import org.coreasim.compiler.plugins.kernel.code.ucode.KernelUpdateRule;
import org.coreasim.compiler.plugins.kernel.preprocessor.IDSpawner;
import org.coreasim.compiler.plugins.kernel.preprocessor.RuleParamInheritRule;
import org.coreasim.compiler.plugins.kernel.preprocessor.SignatureTransformer;
...
public class CompilerKernelPlugin extends CompilerCodePlugin implements
	...
	public List<MainFileEntry> loadClasses(ClassLibrary classLibrary)
		...
		if (enginePath == null) {
			...
			classLibrary.addPackageReplacement("org.coreasm.engine.interpreter.EnvironmentAgent", engine.getPath().runtimePkg() + ".EnvironmentAgent");
			...
			try {
				...
				classLibrary.addEntry(new JarInclude(engine, enginePath, 
						"org/coreasm/engine/interpreter/EnvironmentAgent.java", 
